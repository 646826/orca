...
export const LIFIC_TASK_PROVIDER_RUNTIME_CAPABILITY = 'lific.task-provider.v1' as const
export const LIFIC_PROVISIONING_RUNTIME_CAPABILITY = 'lific.provisioning.v1' as const
